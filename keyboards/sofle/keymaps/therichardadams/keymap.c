...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_MPLY, KC_N,   KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                     KC_LCTL,KC_LALT,KC_LGUI,MO(_LOWER), KC_SPC,       KC_ENT, MO(_RAISE),KC_RGUI, KC_RALT, KC_HYPR
    ),
    /*
     * COLEMAK
     * ,-----------------------------------------.                    ,-----------------------------------------.
     ...
     * |      |      |      |      |      |      |                    | Home |      |      |      |      |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Esc  | Ins  | Pscr | Menu |      |      |                    | PgUp | PTab |  Up  | NTab | DLine| Del  |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Tab  | LSt  | PWrd | NWrd | LEnd | Caps |-------.    ,-------| PgDn | Left | Down | Right| Bspc | Del  |
     * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
     * |Shift |      |      |      |      |      |-------|    |-------| End  | Back |      | Fwd  |      |      |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LGUI | LAlt | LCTR |LOWER | /Space  /       \Enter \  |RAISE | RCTR | RAlt | RGUI |
    ...
    [_RAISE] = LAYOUT(
      ...
      _______,   KC_INS,  KC_PSCR,   KC_APP, XXXXXXX, XXXXXXX,                           KC_PGUP,  KC_PTAB,    KC_UP,  KC_NTAB, KC_DLINE,  KC_DEL,
      _______, KC_LSTRT, KC_PRVWD, KC_NXTWD, KC_LEND, KC_CAPS,                           KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_BSPC,  KC_DEL,
      _______,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, _______,         _______,  KC_END,  KC_BBCK,  XXXXXXX,  KC_BFWD,  XXXXXXX, _______,
                      _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______
    ),
    /* ADJUST
     * ,-----------------------------------------.                    ,-----------------------------------------.
     * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |BTLDR |      |QWERTY|COLMAK|      |      |                    |      | OLEDL| OLEDM| OLEDH|      |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
    ...
    [_ADJUST] = LAYOUT(
      ...
      QK_BOOT, XXXXXXX, KC_QWERTY,KC_COLEMAK, CG_TOGG, XXXXXXX,                       XXXXXXX, KC_OLDL, KC_OLDM, KC_OLDH, XXXXXXX, XXXXXXX,
